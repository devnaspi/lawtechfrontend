                ...
                <StyledToolbar variant="dense" disableGutters>
                    ...
                    >
                        {auth.isAuthenticated ? (
                            ...
                            <>
                                <Button color="primary" variant="text" size="small" onClick={() => router.push('/readers/login')}>
                                    Sign in
                                </Button>
                                <Button color="primary" variant="contained" size="small" onClick={() => router.push('/readers/sign-up')}>
                                    Sign up
                                </Button>
                            </>
                        )}
